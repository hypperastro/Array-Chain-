...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x43ee;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(270000000);
...
const char     CRYPTONOTE_NAME[]                             = "Array";
...
const int      P2P_DEFAULT_PORT                              = 69420;
